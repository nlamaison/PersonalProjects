...
def generate_mock_sim_world(bounds_x: tuple[float, float], bounds_y: tuple[float, float], n_obstacles: int, guarantee_connectivity: bool = True, max_iterations: int = 100) -> SimWorld:
    ...
    while (len(obstacles) < n_obstacles): 
        ...
        # TODO(nico): Probably a more elegant way to do this...
        ...
        # Attempt adding the new obstacle to the sim world. Check non-obstacle point connectivity.
        ...
        if new_free_space.geom_type == "Polygon" or not guarantee_connectivity:
